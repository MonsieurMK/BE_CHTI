...
Somme
	...
	ldrsh	r7, [r8, r5, lsl #1]
	mul		r3, r7 ; x(n) * sin
	add		r9, r3 ; somme de la partie imaginaire
	...
	;mul		r0, r12, r12 ; on a un format 5.27 au carré (car on prend le module au carré de la partie réelle uniquement), on a donc un format 10.54 en retour de fonction
	pop 	{r4-r9}
	bx		lr
	endp
